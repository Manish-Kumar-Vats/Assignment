...
public class QueryUtils {
    ...
    public static List<RestaurantModel> fetchArticleData(String requestUrl) {
        ...
        List<RestaurantModel> restaurantList = extractFromJson(jsonResponse);

        return restaurantList;
    }

    public static List<RestaurantModel> extractFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < restaurants.length(); i++) {
                ...
                JSONObject currentRestaurant = restaurants.getJSONObject(i);

                String name = currentRestaurant.getString("name");
                String url = currentRestaurant.getString("url");

                RestaurantModel restaurant = new RestaurantModel(name, url);
...
//            urlConnection.setRequestProperty("user-key", "bd2ed07b3fb495e9ba44a58a4f3cfba9");
